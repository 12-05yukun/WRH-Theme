        ...
        <div class='footer-info'>
		    ...
		    <div class='footer-policy-container'>
					 ...
					 <div class='footer-policy'> 
                                         <?php if(the_field('datenschutz', 'option')){?><a href='<?php  the_field('datenschutz', 'option')?>'>Datenschutz</a><?php }?>
                               <?php if(the_field('impressum', 'option')){?>  <a href='<?php  the_field('impressum', 'option')?>'>| Impressum </a><?php }?>
                              <?php if(the_field('agb', 'option')){?>   <a href='<?php  the_field('agb', 'option')?>'>| AGB </a><?php }?>
                              <?php if(the_field('karriere', 'option')){?><a href='<?php  the_field('karriere', 'option')?>'> | Karriere </a><?php }?>
                                         </div>
	      </div>
