...
<div class='row angebot-list'>
  ...
  <div class='angebot-list-items'>
    <?php if ($angebots){ foreach($angebots as $angebot){ $punkte=get_field('punkte',$angebot);  $permalink = get_field('link', $angebot)  ? get_field('link', $angebot):  get_permalink( $angebot->ID );?>
